...
class Config:
    def __init__(self):
        ...
        self.JELLYFIN_SERVER_URL = config.get('Jellyfin', {}).get('server_url', 'http://127.0.0.1:8096')
        ...
        self.SONARR_API_URL = config.get('Sonarr', {}).get('api_url', 'http://127.0.0.1:8989')
        self.SONARR_API_KEY = config.get('Sonarr', {}).get('api_key', '<Sonarr API Key>')

        # Radarr Configuration
        self.RADARR_API_URL = config.get('Radarr', {}).get('api_url', 'http://127.0.0.1:7878')
        self.RADARR_API_KEY = config.get('Radarr', {}).get('api_key', '<Radarr API Key>')

        # Lidarr Configuration
        self.LIDARR_API_URL = config.get('Lidarr', {}).get('api_url', 'http://127.0.0.1:8686')
        self.LIDARR_API_KEY = config.get('Lidarr', {}).get('api_key', '<Lidarr API Key>')
